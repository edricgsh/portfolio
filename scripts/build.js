...
const home = '<div class="col"><section class="hero">' +
  ...
  '<section class="section">' + sectionHead('01', 'Now') + '<ul class="rows">' +
    ...
    row('Lingooso <span class="live" aria-label="Live"></span>', 'Turn any YouTube video into a full language lesson. More than 60 early users are learning across ten languages.', '', 'VOCABULARY · FLASHCARDS · AI QUIZZES · SPACED REPETITION', 'https://www.lingooso.com/') +
  ...
  '<section class="section">' + sectionHead('02', 'Selected projects', '/projects/', 'All projects') + '<ul class="rows">' +
    ...
    row('Lingooso', 'A full language lesson from one YouTube link. It creates vocabulary, flashcards, quizzes, and progress tracking.', 'LIVE · 60+ EARLY USERS', 'AI · VIDEO · SM-2 · 10 LANGUAGES', '/projects/#lingooso') +
...
const projects = '<div class="wide"><header class="page-head prose-width"><p class="eyebrow">Projects</p><h1>Selected products and systems.</h1><p>I work across product, backend, frontend, AI, and delivery. These projects show the range.</p></header>' +
  ...
  '<article class="case-study" id="lingooso"><div><p class="eyebrow">Current · Live</p><h2>Lingooso</h2><p class="case-study__dek">Turn any YouTube video into a complete language lesson.</p><ul class="case-study__facts"><li><strong>60+</strong><span>early users</span></li><li><strong>10</strong><span>languages</span></li><li><strong>4</strong><span>learning tools</span></li></ul><div class="case-study__body"><p>Lingooso creates vocabulary, flashcards, quizzes, and synced reading from real video. It explains each word in context.</p><p>More than 60 early users are testing the product and shaping what comes next. Spaced repetition helps them review each word at the right time.</p></div><div class="actions"><a class="btn btn--secondary" href="https://www.lingooso.com/">Visit Lingooso</a></div><div class="stack">AI · VIDEO PROCESSING · SM-2 · TEXT TO SPEECH · ANALYTICS</div></div><figure class="case-study__media"><img src="/assets/lingooso.jpg" alt="Lingooso language lesson product preview" loading="lazy"><figcaption>Language lessons built from YouTube content.</figcaption></figure></article>' +
