...
function nav(active) {
  ...
  return '<header class="masthead"><div class="wide masthead__inner">' +
    '<a class="brand" href="/" aria-label="Edric Gan, home"><img src="/assets/eg-monogram.svg" alt="" width="32" height="32"><strong>Edric Gan</strong></a>' +
...
const home = '<div class="wide home"><section class="hero hero--portrait">' +
  ...
  '</section><div class="home__content">' +
  '<section class="section">' + sectionHead('01', 'Now') + '<ul class="rows">' +
    row('Tech Lead at a fintech company <span class="live" aria-label="Current role"></span>', 'I lead a six-person team and work with the card-issuing transactions team on systems that process millions of dollars each month.', '', '6-PERSON TEAM · CARD ISSUING · HIGH-VOLUME TRANSACTIONS', '/work/') +
    row('AI Tech Advisor', 'I have advised four companies working on social media AI, Web3 VTuber tools, real-time speech synthesis, and software delivery. My work covered AI architecture, CI/CD, and infrastructure hardening.', '', 'AI ARCHITECTURE · VTUBER SYSTEMS · SPEECH SYNTHESIS · CI/CD · INFRASTRUCTURE') +
    row('Coaching and training engineers', 'I have coached engineers and trained more than 100 adult learners. I focus on system design, backend work, AI, and career growth.', '', '', '/coaching/') +
  '</ul></section>' +
  ...
  '<section class="section">' + sectionHead('04', 'Coaching & training', '/coaching/', 'How I help') + '<ul class="rows">' +
    '<li><div class="row"><div><h3>One-to-one coaching</h3><p>Clear plans for system design, backend skills, AI work, interviews, and the move to senior roles.</p><blockquote class="quote">“Edric is very good at understanding my needs and managed to exceed expectations every time.”<cite>— Pierre-Edouard, coached for two years</cite></blockquote><blockquote class="quote">“Edric structured learning projects that helped me grasp core concepts.”<cite>— Ying Xuan, coached for one year</cite></blockquote><blockquote class="quote">“His guidance helped me see the path to becoming a more successful engineer.”<cite>— Adrian, coached for six months</cite></blockquote></div><span class="meta">100+ PEOPLE TRAINED</span></div></li>' +
  ...
  '<section class="contact-block" id="contact"><div class="contact-block__inner"><p class="eyebrow">Work together</p><h2>Building or backing an ambitious product?</h2><p>I work with founders, investors, and engineering teams to assess technical opportunities, shape AI products, and turn complex plans into working systems.</p><div class="actions"><a class="btn btn--primary" href="mailto:edricgan.44@gmail.com">Discuss an opportunity</a><a class="btn btn--secondary" href="/projects/">See selected work</a></div></div></section></div></div>';
